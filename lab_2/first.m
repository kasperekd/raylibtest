...
end_d = 25000; % Конечное расстояние для расчётов
...
% Функция расчёта основных параметров (thermal noise, sensitivity, MIMO gain)
...
% Функция расчёта максимальных потерь пути
...
% Функция расчёта модели UMi NLOS
...
% Функция нахождения пересечения модели с MAPL
...
% Функция построения графиков для UMiNLOS и FSPL
...
legend show; % Показываем легенду только для видимых объектов
grid on;
hold off;
